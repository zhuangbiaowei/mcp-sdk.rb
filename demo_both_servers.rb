...
puts ""
puts "   Then test with HTTP requests:"
puts "   curl http://localhost:8080/health"
puts "   curl http://localhost:8080/tools"  
puts "   curl -X POST http://localhost:8080/mcp -H 'Content-Type: application/json' -d '{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/call\",\"params\":{\"name\":\"add\",\"arguments\":{\"a\":5,\"b\":3}}}'"
